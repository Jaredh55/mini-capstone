...
Product.create!([
  ...
  {name: "Magic Cards", price: "50.0", image_url: nil, description: "magical cards", supplier_id: 1}
])
Image.create!([
...
User.create!([
  {name: "Jimmy John", email: "jim@jimmyjohns.org", password_digest: "$2a$10$rKzRwzG9WyKLZ20iAudR2ucqN1Y/VSj5WG3DkM17fSFHB24n2.7AS", admin: false},
  {name: "Sue Everyone", email: "sue@everyone.org", password_digest: "$2a$10$qEmhCBjhwqfSyqsToYje3ek141buPpxvtTUIkxE6U3rLzBI4GtRIu", admin: true},
  {name: "Jack Sparrow", email: "jacksparrow@pirate.com", password_digest: "$2a$10$Tg1muu1SragMGyJ/YzKT0ex2JzeyX73pM1Mua8TO.juMGULAOWTye", admin: false}
])
Order.create!([
  {user_id: 1, subtotal: "70.0", tax: "8.0", total: "78.0"}
])
...
CartedProduct.create!([
  ...
  {user_id: 1, product_id: 4, quantity: nil, status: "removed", order_id: nil},
  {user_id: 2, product_id: 5, quantity: nil, status: "carted", order_id: nil},
  {user_id: 1, product_id: 4, quantity: 1, status: "carted", order_id: nil},
  {user_id: 1, product_id: 6, quantity: 1, status: "carted", order_id: nil}
])
